...
describe(#state{threshold = Threshold, default_value = DefaultValue}) ->
    ["replace_below_confidence(", float_to_list(Threshold), ", ",
...
help() ->
    <<"Replaces the metric equal to or below given threshold with the"
      " default value. This can be either applied to raw serieses or"
      " aggregates.">>.
